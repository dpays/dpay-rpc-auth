...
Request signing for [JSON-RPC 2.0](http://www.jsonrpc.org/specification) implemented using [dPay](https://dpays.io) authorities.
...
Requests are signed with dPay keys belonging to the sender.
...
# Signing constant K (sha256('dpay_jsonrpc_auth'))
...
### Signature validation
  ...
  1. `request['params']['__signed']['account']` must be a valid dPay blockchain account
